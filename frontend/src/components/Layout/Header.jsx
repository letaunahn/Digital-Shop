    ...
    <>
      <div className={`${styles.section}`}>
        <div className="hidden md:h-[50px] md:my-[20px] md:flex items-center justify-between">
          ...
          <div className="w-1/2 relative" onBlur={handleBlur}>
            <input
              type="text"
            ...
            />
            {isFocused && searchData && searchData.length !== 0 ? (
        ...
        {open && (
          <div
            ...
            <div className="fixed w-[70%] bg-[#fff] h-screen top-0 left-0 z-10 overflow-y-scroll">
              ...
              <Navbar active={activeHeading} />
              <div className={`${styles.button} ml-4 !rounded-lg`}>
                <Link to="/shop-create">
                ...
                {isAuthenticated ? (
                  <div>
                    <Link to="/profile">
                      <img
                        src={`${user.avatar.url}`}
                        className="w-[60px] h-[60px] object-cover rounded-full border-[3px] border-[#0eae88]"
                        alt=""
                      />
                    </Link>
                  </div>
