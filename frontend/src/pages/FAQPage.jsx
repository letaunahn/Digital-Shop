        ...
        <div className="mx-auto space-y-4">
            ...
            {activeTab === 4 && (
              <div className="mt-4">
                <p className="text-base text-gray-500">
                  ...
                  support@myecommercestore.com, or by calling us at (84)
                  083-823-7190 between the hours of 9am and 5pm EST, Monday through
                  Friday.
                </p>
              </div>
            )}
          ...
          <div className="border-b border-gray-200 pb-4">
            ...
            {activeTab === 6 && (
              <div className="mt-4">
                <p className="text-base text-gray-500">
                  Currently, we only offer shipping within Viet Name.
                </p>
              </div>
            )}
          </div>
